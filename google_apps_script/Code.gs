...
5) Copiar la URL .../exec a inscripciones_IM/web_config.js -> sheetsAppendUrl
*/

const SPREADSHEET_ID = '1QRTPIEaMHVOR4SqIbf6jMFqnEVmxQJFmlpDAUTD0GRA';
const SHEET_NAME = 'Inscripciones IM';
